...
public final class ListsUtils {
     ...
     */
    public static <T> T getObjectWithMaxProperty(final List<T> list, final Function<? super T, Double> propertyExtractor) {
     ...
     */
    public static <T> T getObjectWithMinProperty(final List<T> list, final Function<? super T, Double> propertyExtractor) {
     ...
     *            asc
     */
    public static <T> void orderListDate(final List<T> list, final Function<T, Date> orderCriteriaExtractor, final boolean asc) {
     ...
     *            asc
     */
    public static <T> void orderListLong(final List<T> list, final Function<T, Long> orderCriteriaExtractor, final boolean asc) {
     ...
     *            asc
     */
    public static <T> void orderListDouble(final List<T> list, final Function<T, Double> orderCriteriaExtractor, final boolean asc) {
     ...
     * @return if the object is in the list
     */
    public static <T> boolean isObjectInList(final T obj, final List<T> list, final Function2Arg<T, T, Boolean> equalsFunction) {
    ...
    /**
     * Returns the distinct items by id.
     *
     * @param <T>
     *            type of object
     * @param <ID>
     ...
     * @param functionGetId
     *            functionGetId
     * @return the distinct items by id
     */
    public static <T, ID> List<T> distinctById(final List<T> list, final Function<T, ID> functionGetId) {

        final Map<ID, T> map = new HashMap<ID, T>();

        for (final T item : list) {
            map.put(functionGetId.apply(item), item);
        }

        return buildList(map.values());
    }

    /**
     * Returns the first object with more value.
     *
     * @param <T>
     *            type of object
     * @param list
     *            list
     * @param functionGetValue
     *            functionGetValue
     * @param value
     *            value
     * @return the first object with more value
     */
    public static <T> T getFirstObjectWithMoreValue(final List<T> list, final Function<T, Double> functionGetValue, final Double value) {

        final List<T> listGreaterValues = filterList(list, o -> value < functionGetValue.apply(o));
        return getObjectWithMinProperty(listGreaterValues, functionGetValue);
    }

    /**
     * Returns the first object with less value.
     *
     * @param <T>
     *            type of object
     * @param list
     ...
     * @param value
     *            value
     * @return the first object with less value
     */
    public static <T> T getFirstObjectWithLessValue(final List<T> list, final Function<T, Double> functionGetValue, final Double value) {

        final List<T> listLesserValues = filterList(list, o -> value > functionGetValue.apply(o));
        return getObjectWithMaxProperty(listLesserValues, functionGetValue);
    }

    /**
     * Returns the first object after the date.
     *
     * @param <T>
     *            type of object
     * @param list
     *            list
     * @param functionGetDate
     *            functionGetDate
     * @param date
     *            date
     * @return the first object after the date
     */
    public static <T> T getFirstObjectAfter(final List<T> list, final Function<T, Date> functionGetDate, final Date date) {
        return getFirstObjectWithMoreValue(list, o -> (double) functionGetDate.apply(o).getTime(), (double) date.getTime());
    }

    /**
     * Returns the first object before the date.
     *
     * @param <T>
     *            type of object
     * @param list
     ...
     * @param date
     *            date
     * @return the first object before the date
     */
    public static <T> T getFirstObjectBefore(final List<T> list, final Function<T, Date> functionGetDate, final Date date) {
        return getFirstObjectWithLessValue(list, o -> (double) functionGetDate.apply(o).getTime(), (double) date.getTime());
    }
}
